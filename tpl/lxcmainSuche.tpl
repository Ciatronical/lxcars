...
<html>
   ...
   {PRE_CONTENT}
   {START_CONTENT}
   <p class="ui-state-highlight ui-corner-all tools" style="margin-top: 20px; padding: 0.6em;" onClick="help('SuchFirma');"> Suche nach Fahrzeugen und verkn&uuml;pften Daten</p>
