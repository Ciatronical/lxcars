...
<tr><td class="info infoleft FahrzeuscheinAbg">Emissionsklasse<span></span></td><td><input tabindex="4" type="text" name="c_em" size="12" maxlength="6" value="{c_em}" title="Fahrzeugschein Seite zwei, mitte,Feld 14" onclick=select() {readonly}><input tabindex="-1" type="checkbox" name="chk_c_em" value="true" {chk_c_em} title="Eingabe prüfen"><input type="button" name="Info" value="Info" onclick="feinstaub()"></td><td class="info inforightright FahrzeuscheinHub">Hubraum:<span></span></td><td><input id="c_hubr" name="c_hubr" tabindex="-1" type="text" size="29" value="{vh}" title="Zylindervolumen" readonly="readonly"></td></tr>
...
<tr><td>Zustand Sommerreifen</td><td><input tabindex="17" type="text" name="c_st_z" size="12" value="{c_st_z}" title="gut, mittel, schlecht oder Profiltiefe angeben"></td><td>Zahnriemen gewechselt am:</td><td><input type="text" id="c_zrd" name="c_zrd" size="29" maxlength="10" value="{c_zrd}" title="" onclick=select() {readonly}></td></tr>
<tr><td>Zustand Winterreifen</td><td><input tabindex="18" type="text" name="c_wt_z" size="12" value="{c_wt_z}" title="gut, mittel, schlecht oder Profiltiefe angeben"></td><td>(ZR-Wechsel) KM-Stand:</td><td><input type="text" id="c_zrk" name="c_zrk" size="29" maxlength="10" value="{c_zrk}" title="" onclick=select() {readonly}></td></tr>
