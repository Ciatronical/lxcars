...
<tr><td>Anzahl der Zylinder</td><td><input tabindex="11" type="text" name="stuetzlast" size="16" maxlength="22" value="{stuetzlast}" title="Fahrzeugschein Seite 3, Feld R" {readonly}></td><td>Anzahl der Ventile</td><td title="Abstand zwischen den Achsen"><input name="leitungsgewicht" tabindex="-1" type="text" size="16" value="{leitungsgewicht}" title="Anzahl der Ventile" {readonly}></td></tr>
...
<tr><td class="info infoleft FahrzeuscheinMasse">Gesammtmasse G<span></span></td><td><input tabindex="16" type="text" name="masse_leer" size="16" value="{masse_leer}" title="Gesammtmasse"></td><td>Radstand</td><td title="Abstand zwischen den Achsen"><input name="achslast_3" tabindex="-1" type="text" size="16" value="{achslast_3}" title="Abstand zwischen den Achsen" {readonly}></td></tr>
<tr><td class="info infoleft FahrzeuscheinReifen">Bereifung 15.1<span></span></td><td><input name="reifung_achs1" tabindex="15" type="text" name="c_st_l" size="16" value="{reifung_achs1}" title="Reifendimension"></td><td class="info inforight FahrzeuscheinVmax">Geschwindigkeit T<span></span></td><td><input name="geschwindigkeit" tabindex="-1" type="text" size="16" value="{geschwindigkeit}" title="H&ouml;chstgeschwindigkeit" {readonly}></td></tr>
<tr><td>bearbeitet am</td><td><input tabindex="18" type="text" name="c_wt_z" size="16" value="{c_wt_z}" title="Wann wurde der Datensatz zuletzt bearbeitet" readonly="readonly"></td><td>bearbeitet von</td><td><input tabindex="-1" type="text" size="16" value="{emp}" title="dein Name" readonly="readonly"></td></tr>
</table>
