...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="lxcars/css/lxcjquery.autocomplete.css">
	 <script type="text/javascript" src="lxcars/inc/lxcjquery.js"></script>
	 <script type="text/javascript" src="lxcars/inc/lxcjquery.autocomplete.js"></script>
    ...
    $(function() {
		...
		url: 'lxc_ac.php',  
		minChars: 2,
		onItemSelect: function(myitem) {
					//alert( myitem.data );
					var da = String(myitem.data);
					var co_bl = da.split("__");
					$("#country").val(co_bl[0]);	
					//alert( co_bl[1]);
					$("#bland").val(co_bl[1]);	 
					$("#city").focus();   		
		    		var plz = myitem.value;
		    		$("#city").autocomplete({
						url: 'lxc_ac.php',
						inputClass: 'acInputOrt',
						minChars: 0,
						extraParams: { plz: plz },
						onItemSelect: function(myitem) {
							$("#phone").focus(); 
	   ...
	   inputClass: 'acInputPlz'
	});
	var street = '1';
  	$("#street").autocomplete({
					url: 'lxc_ac.php',
					inputClass: 'acInputOrt',
					extraParams: { street: street },
							
			});
	$("#shiptozipcode").autocomplete({
		url: 'lxc_ac.php',  
		minChars: 2,
		onItemSelect: function(myitem) {
					//alert( myitem.data );
					var da = String(myitem.data);
					var co_bl = da.split("__");
					$("#shiptocountry").val(co_bl[0]);	
					//alert( co_bl[1]);
					$("#shiptobland").val(co_bl[1]);	 
					$("#shiptocity").focus();   		
		    		var plz = myitem.value;
...
<!-- END anreden -->
    ...
    <div class="zeile2">
        ...
        <span class="feldxx"><input type="text" id="street" name="street" size="35" maxlength="75" value="{street}" tabindex="6" autocomplete="off"></span>
    </div>
    <div class="zeile2">
        <span class="label klein">.:country:. / .:zipcode:. lxc</span>
        <span class="feldxx">
            <input type="text" id="country" name="country" size="2" maxlength="75" value="{country}"  onBlur="mkBuland('bland')">/
            <input type="text" id="zipcode" name="zipcode" size="5" maxlength="10" value="{zipcode}" tabindex="8" autocomplete="off">
            <select name="bland" id="bland"  style="width:150px;">
                <option value=""></option>
<!-- BEGIN buland -->
...
<!-- END buland -->
    ...
    <div class="zeile2">
        ...
        <span class="feldxx"><input type="text" id="city" name="city" size="35" maxlength="75" value="{city}" tabindex="10" autocomplete="off"></span>
    </div>
    <div class="zeile2">
...
<!-- END shiptos -->
    ...
    <div class="zeile2">
        <span class="label klein">.:street:.</span>
        <span class="feldxx"><input type="text" id="shiptostreet" name="shiptostreet" size="35" maxlength="75" value="{shiptostreet}" tabindex="5" autocomplete="off"></span>
    </div>
    <div class="zeile2">
        <span class="label klein">.:country:. / .:zipcode:.</span>
        <span class="feldxx">
            <input type="text" id="shiptocountry" name="shiptocountry" size="2" value="{shiptocountry}" onBlur="mkBuland('shiptobland');">/
            <input type="text" id="shiptozipcode" name="shiptozipcode" size="5" maxlength="10" value="{shiptozipcode}" tabindex="7" autocomplete="off">
            <select id="shiptobland" name="shiptobland" id="shiptobland"  style="width:12em;">
                <option value=""></option>
<!-- BEGIN buland2 -->
...
<!-- END buland2 -->
    ...
    <div class="zeile2">
        <span class="label klein">.:city:.</span>
        <span class="feldxx"><input type="text" id="shiptocity" name="shiptocity" size="35" maxlength="75" value="{shiptocity}" tabindex="9" autocomplete="off"></span>
    </div>
    <div class="zeile2">
        <span class="label klein">.:phone:.</span>
